...
public partial class WorksheetList : UserControl {
  public WorksheetList() { InitializeComponent(); }
  ...
  private void lstWorksheets_SelectedIndexChanged(object sender, EventArgs e) {
    Microsoft.Office.Interop.Excel.Worksheet sheet =
        (Microsoft.Office.Interop.Excel.Worksheet)Globals.ThisAddIn.Application
            .Worksheets[lstWorksheets.SelectedItems[0].Text];
    ...
    try {
      Microsoft.Office.Interop.Excel.Worksheet sheet =
          (Microsoft.Office.Interop.Excel.Worksheet)Globals.ThisAddIn
              .Application.Worksheets[lstWorksheets.SelectedItems[0].Text];
      ...
      case "Very Hidden":
        sheet.Visible =
            Microsoft.Office.Interop.Excel.XlSheetVisibility.xlSheetVeryHidden;
        break;
      }
  ...
  private void LoadListview() {
    try {
      ...
      int visible = 0;
      foreach (Microsoft.Office.Interop.Excel.Worksheet sheet in book
                   .Worksheets) {
  ...
  private void tsbRefresh_Click(object sender, EventArgs e) { LoadListview(); }

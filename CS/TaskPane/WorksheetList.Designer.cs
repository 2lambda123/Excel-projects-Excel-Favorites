  ...
  private void InitializeComponent() {
    ...
    System.ComponentModel.ComponentResourceManager resources =
        new System.ComponentModel.ComponentResourceManager(
            typeof(WorksheetList));
    this.imgXlSheetVisibility =
        new System.Windows.Forms.ImageList(this.components);
    this.mnuSetVisiblity =
    ...
    //
    this.imgXlSheetVisibility.ImageStream =
        ((System.Windows.Forms.ImageListStreamer)(
            resources.GetObject("imgXlSheetVisibility.ImageStream")));
    this.imgXlSheetVisibility.TransparentColor =
    ...
    // mnuSetVisiblity
    //
    this.mnuSetVisiblity.Items.AddRange(
        new System.Windows.Forms.ToolStripItem[] { this.tmiVisible,
                                                   this.tmiHidden,
                                                   this.tmiVeryHidden });
    ...
    // tmiVeryHidden
    //
    this.tmiVeryHidden.Image =
        global::Favorites.Properties.Resources.bullet_key;
    ...
    this.tmiVeryHidden.Click +=
        new System.EventHandler(this.tmiVisiblity_Click);
    //
    // columnHeader1
    //
    ...
    // lstWorksheets
    //
    this.lstWorksheets.Anchor = ((System.Windows.Forms.AnchorStyles)(
        (((System.Windows.Forms.AnchorStyles.Top |
           System.Windows.Forms.AnchorStyles.Bottom) |
          System.Windows.Forms.AnchorStyles.Left) |
         System.Windows.Forms.AnchorStyles.Right)));
    this.lstWorksheets.Columns.AddRange(
        new System.Windows.Forms.ColumnHeader[] { this.columnHeader1 });
    this.lstWorksheets.Font = new System.Drawing.Font(
    ...
    this.lstWorksheets.HeaderStyle =
    ...
    this.lstWorksheets.SelectedIndexChanged +=
        new System.EventHandler(this.lstWorksheets_SelectedIndexChanged);
    this.lstWorksheets.MouseClick += new System.Windows.Forms.MouseEventHandler(
        this.lstWorksheets_MouseClick);
    //
    // tspWorksheetMenu
    //
    this.tspWorksheetMenu.GripStyle =
        System.Windows.Forms.ToolStripGripStyle.Hidden;
    this.tspWorksheetMenu.Items.AddRange(
        new System.Windows.Forms.ToolStripItem[] { this.tsbRefresh,
    ...
    // tsbRefresh
    //
    this.tsbRefresh.Image =
        global::Favorites.Properties.Resources.arrow_refresh;
    ...
    // tsbSortAsc
    //
    this.tsbSortAsc.Image =
        global::Favorites.Properties.Resources.bullet_arrow_up;
    ...
    // tsbSortDesc
    //
    this.tsbSortDesc.Image =
        global::Favorites.Properties.Resources.bullet_arrow_down;

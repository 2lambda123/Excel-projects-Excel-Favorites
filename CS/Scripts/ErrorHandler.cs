...
public class ErrorHandler {
  ...
  public static void CreateLogRecord() {
    try {
      ...
      log.Info("[PROCEDURE]=|" + currentProcedure + "|[USER NAME]=|" +
               Environment.UserName + "|[MACHINE NAME]=|" +
  ...
  public static void DisplayMessage(Exception ex, Boolean isSilent = false) {
    ...
    errorMessageDescription = System.Text.RegularExpressions.Regex.Replace(
    ...
    log.Error("[PROCEDURE]=|" + currentProcedure + "|[USER NAME]=|" +
              Environment.UserName + "|[MACHINE NAME]=|" +
              Environment.MachineName + "|[FILE NAME]=|" + currentFileName +
